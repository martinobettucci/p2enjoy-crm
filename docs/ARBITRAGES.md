...
| INC-046, INC-073 | geste pluriel atomique, mapping exhaustif — **livré et prouvé** | `CRM-019` `[x]` |
...
| Le fil nomme `channel_changed` au lieu d'afficher « Événement » | `CRM-019` — livré |
