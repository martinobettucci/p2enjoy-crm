...
//       session n'est pas un refus : la prolongation rend `204`), 593 (INC-249 : `attente_administrateur`)
//
// Module pur. Un refus porte son CODE et, pour les quatre attentes, l'adresse que l'écran nommera.
...
const ATTENTES: ReadonlySet<CodeRefus> = new Set([
	'adresse_non_verifiee',
	'attente_verification',
	'attente_espace',
	'attente_administrateur',
