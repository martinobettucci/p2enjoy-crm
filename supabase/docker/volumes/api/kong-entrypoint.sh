#!/bin/sh
# @spec CRM-001 (docs/BACKLOG.md) — point d'entrée de la passerelle Kong
# @spec docs/DAT.md §3.5 (passerelle et périphérie)
# Repris de la pile self-hosted officielle Supabase (docker/volumes/api/kong-entrypoint.sh).
