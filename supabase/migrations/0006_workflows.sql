...
--       INC-031 (garde d'archivage), INC-033 (corrigée ensuite par CRM-018)
--
...
--
--   * la relation des **champs exigés par transition**. L'ancien tableau ne pouvait porter aucune
--     intégrité référentielle ; CRM-018 le remplace en migration 19, sans que ce rejeu historique
--     recrée la colonne supprimée. INC-033.
--
-- ---------------------------------------------------------------------------------------------
