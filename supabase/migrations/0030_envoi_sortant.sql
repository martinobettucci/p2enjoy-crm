...
begin
	if not exists (
		...
		-- INC-144 — garde symétrique sur les lignes. Douze valeurs ne suffisent plus dès que
		-- CRM-081 a écrit un `snoozed` ou un `woken` ; la migration 44 porte alors le vocabulaire.
