...
-- **pas** écrites ici : elles relèvent d'INC-014, dont l'arbitrage appartient au responsable. Se
-- les attribuer aurait été confortable, cette migration touchant déjà aux politiques.
--
-- ---------------------------------------------------------------------------------------------
-- Rejouabilité.
-- ---------------------------------------------------------------------------------------------
