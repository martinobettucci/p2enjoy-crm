...
describe('le tableau de la vue liste (§12.7)', () => {
	...
	it('porte les cinq colonnes du §12.7, et pas de colonne « Responsable »', () => {
		rendre()
		...
		expect(entetes[1]).toContain(fr['liste.colonne.etape'])
		expect(entetes[2]).toContain(fr['liste.colonne.amount'])
		expect(entetes[3]).toContain(fr['liste.colonne.next_action'])
		expect(entetes[4]).toContain(fr['liste.colonne.next_action_at'])
		expect(entetes.join(' ')).not.toContain('Responsable')
	})
