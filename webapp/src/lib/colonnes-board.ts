 ...
 * demandés : une requête ne rapporte que ce qui est affiché. `owner_id` non plus — le nom du
 * responsable n'est lisible par personne (INC-014), et un identifiant technique à la place d'un nom
 * serait une valeur par défaut trompeuse (§7.4).
 */
export const COLONNES_CARD_BOARD =
	'id, title, position, amount, currency, next_action, current_step_id, entered_step_at, email_local_part'
