...
env_print_dev_credentials() {
	...
	env_credential_line "viewer@${domaine_perso}" "verified — Farida Nowak, lectrice"
	env_credential_line "exploitante@${domaine_perso}" "verified + admin du realm — administratrice de tout espace, sans appartenance (décision 597)"
